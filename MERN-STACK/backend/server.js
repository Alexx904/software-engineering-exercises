...
app.use('/api/workouts', workoutRoutes); // ! questo serve per utilizzare le rotte dei workout, praticamente tutte le richieste che iniziano con /api/workouts saranno gestite dal router workoutRoutes
